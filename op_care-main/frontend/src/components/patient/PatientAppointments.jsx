...
function PatientAppointments() {
  ...
  const fetchDoctorsByHospital = async (hospitalId) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Fallback to getting all doctors
  ...
  // Effect to fetch doctors when hospital changes
  useEffect(() => {
    if (newAppointment.hospitalId) {
      fetchDoctorsByHospital(newAppointment.hospitalId);
    } else {
      setDoctors([]);
    }
  ...
  const handleCreateAppointment = async (e) => {
    ...
    try {
      const appointmentData = {
        user: user.id,
        patientId: user.id,
        hospital: newAppointment.hospitalId,
        hospitalId: newAppointment.hospitalId,
        doctor: newAppointment.doctorId || null,
        ...
        consultationType: newAppointment.consultationType || "in_person",
        status: "pending",
      };
      ...
      if (response.ok) {
        ...
        alert(error.error || error.message || "Failed to create appointment");
      }
    } catch (error) {
            ...
            >
                ...
                <select
                  ...
                  onChange={(e) => {
                    setNewAppointment({
                      ...
                      doctorId: "", // Reset doctor when hospital changes
                    });
                  }}
                  required
                >
              ...
              <div className="form-row">
                ...
                <div className="form-group">
                  ...
                  <select
                    value={newAppointment.consultationType || "in_person"}
                    onChange={(e) =>
                      setNewAppointment({
                        ...newAppointment,
              ...
              <div className="appointment-header">
                <div className="appointment-info">
                  <div className="doctor-info">
                    <h4>
                      👨‍⚕️ Dr. {appointment.doctor?.fullName || "Unknown Doctor"}
                    </h4>
                  ...
                  <div className="hospital-info">
                    ...
                    {appointment.hospital?.city && (
                      <p className="location">📍 {appointment.hospital.city}</p>
                    )}
                  </div>
                </div>
                <div
